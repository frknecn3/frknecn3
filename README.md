...
My name is Furkan. <img src="logo.png" alt="logo" width="10" height="10">

<ul>

  <li>💻I'm currently a M/PERN Fullstack Developer.</li>
  <li>👨‍💻 Interested in many sides of programming, mainly Web Development.</li>
  <li>📝I use HTML, CSS, JS, TypeScript, React.js, Next.js, Node.js, Express, MongoDB and PostgreSQL in my projects.</li>
